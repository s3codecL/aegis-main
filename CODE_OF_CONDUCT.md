...
* Ser paciente con los nuevos contribuyentes
* Dar crédito donde corresponde

Ejemplos de comportamiento inaceptable por parte de los participantes incluyen:

* El uso de lenguaje o imágenes sexualizadas y atención sexual no deseada
* Comentarios trolls, insultantes/derogatorios y ataques personales o políticos
...
Los casos de comportamiento abusivo, acosador o de otro modo inaceptable pueden ser reportados contactando al equipo del proyecto en [TU_EMAIL]. Todas las quejas serán revisadas e investigadas y resultarán en una respuesta que se considere necesaria y apropiada a las circunstancias. El equipo del proyecto está obligado a mantener la confidencialidad con respecto al informante de un incidente.
...
1. **Primera Ofensa**: Advertencia privada con explicación del comportamiento problemático
2. **Segunda Ofensa**: Advertencia pública y período de tiempo fuera del proyecto
3. **Tercera Ofensa**: Prohibición temporal de 30 días
4. **Ofensas Graves o Repetidas**: Prohibición permanente del proyecto

## Guías Adicionales para la Comunidad

### Para Contribuyentes

* **Sé paciente**: Recuerda que todos comenzamos como principiantes
* **Sé constructivo**: Cuando des feedback, explica el "por qué" detrás de tus sugerencias
* **Sé comprensivo**: Los mantenedores son voluntarios con tiempo limitado
* **Asume buenas intenciones**: No todos tienen el mismo contexto cultural o experiencia

### Para Mantenedores

* **Sé accesible**: Responde a issues y PRs en un tiempo razonable
* **Sé claro**: Explica las decisiones, especialmente cuando rechazas contribuciones
* **Sé agradecido**: Reconoce el tiempo y esfuerzo de los contribuyentes
* **Sé justo**: Aplica las reglas de manera consistente para todos
...
Para respuestas a preguntas comunes sobre este código de conducta, ve a https://www.contributor-covenant.org/faq
